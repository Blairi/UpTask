...
// IFII: Función que se manda a llamar sola
( function(){
    ...
    async function obtenerTareas() {
        try {
            ...
            const url = `${dominio}/api/tareas?id=${id}`;
    ...
    function mostrarTareas() {
        ...
        arrayTareas.forEach(tarea => {
            ...
            btnEstadoTarea.ondblclick = function() {
                // Enviar una copia a la función para no modificar el arreglo original
    ...
    async function actualizarTarea(tarea) {
        ...
        try {
            const url = `${dominio}/api/tarea/actualizar`;
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
    ...
    async function eliminarTarea(tarea) {
        ...
        try {
            const url = `${dominio}/api/tarea/eliminar`;
            const respuesta = await fetch(url, {
                method: 'POST',
                body: datos
            });
